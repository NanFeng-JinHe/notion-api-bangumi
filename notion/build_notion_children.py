...
def build_children(cover, details):
    """
    当前脚本将构建"页面中"的多个块级元素,(build-children)
    每一个块级元素是对应markdown中的无序列表,列表中分为普通文本和链接
    :param cover: 封面链接
    :param details: 详细信息
    :return: children 可参考example-children中的children
    """
    # details: 详细信息示例:
    #  [
    ...
    #     ' 话数: 1',
    #       ···
    #     ' 分镜: [藤田春香](https://bgm.tv/person/1498)',
    #     ' 企画プロデューサー 企画営業プロデューサー: 八田英明'
    #   ]
    children = []
...
def build_details_li_href(item_content):
    ...
    :param item_content: 待解析文本
    """
    # item_content:示例 编剧: [章攀](https://movie.douban.com/celebrity/1452422/)
